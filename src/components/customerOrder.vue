<template>
    <div>
        ...
        <div class="row">
        <div class="col-md-4 mb-4 mt-3" v-for="item in products" :key="item.id">
        <div class="card border-0 shadow-sm h-100">
            <div style="height: 250px; background-size: cover; background-position: center" :style="{'backgroundImage' : `url(${item.imageUrl})`}"></div>
            <div class="card-body">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title h3" id="exampleModalLabel">{{ product.title }}</h5>
            ...
            <div class="modal-body">
                ...
                <h5 class="mt-3 text-secondary"> {{ product.content }} </h5>
